...
@interface AYPersonNumberPickView()<UIPickerViewDataSource, UIPickerViewDelegate>
...
@implementation AYPersonNumberPickView

+ (instancetype)showOnView:(UIView *)view {
    AYPersonNumberPickView *datePickView = [[AYPersonNumberPickView alloc] initWithFrame:CGRectMake(0, 0, 100, 100)];
